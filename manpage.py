...
programManpage = {
    ...
    'contents': r"""{
        ...
        **pw** is a password generator that is capable of generating two types 
        ...
        pass phrases generated by **pw** consist of at least 4 words, each word 
        is taken from a dictionary of 10,000 words. Thus, even if a bad guy knew 
        that four lower case words were being used for your pass phrase, there 
        are still 10,000,000,000,000,000 possible combinations for him to try.  
