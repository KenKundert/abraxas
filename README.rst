...
she has created a Google Docs account with the name "abdocs" and uploaded 
...
If you use Firefox, I recommend you add 'Hostname in Titlebar' so that **pw** 
can recognize which account to use purely from the URL.
